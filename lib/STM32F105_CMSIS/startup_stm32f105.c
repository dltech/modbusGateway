...
extern const VECTOR_TABLE_Type __VECTOR_TABLE[240];
  ...
  CAN1_RX0_Handler,             // CAN RX0 interrupt
  CAN1_RX1_Handler,             // CAN RX1 interrupt
  CAN1_SCE_Handler,             // CAN SCE interrupt
  EXTI9_5_Handler,              // EXTI Line[9:5] interrupts
  TIM1_BRK_Handler,             // TIM1 break interrupt
  TIM1_UP_Handler,              // TIM1 Update interrupt
  TIM1_TRG_COM_Handler,         // TIM1 Trigger and Communication interrupts
  ...
  OTG_FS_WKUP_Handler,          // USB On-The-Go FS Wakeup through EXTI line interrupt
  0,0,0,0,0,0,0,
  ...
  DMA2_Channel4_Handler,        // DMA2 Channel4 global interrupt
  DMA2_Channel5_Handler,        // DMA2 Channel5 global interrupt
  ETH_Handler,                  // Ethernet global interrupt
  ETH_WKUP_Handler,             // Ethernet Wakeup through EXTI line interrupt
  CAN2_TX_Handler,              // CAN2 TX interrupts
  CAN2_RX0_Handler,             // CAN2 RX0 interrupts
  CAN2_RX1_Handler,             // CAN2 RX1 interrupt
  CAN2_SCE_Handler,             // CAN2 SCE interrupt
  OTG_FS_Handler,               // USB On The Go FS global interrupt
  /* Interrupts 68 .. 223 are left out */
};
